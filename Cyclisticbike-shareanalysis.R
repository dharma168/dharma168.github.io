...
# individual quarter's data frames into one big data frame
...
#changing to proper date and time formats
...
# summary() on the specific attribute
...
write.csv(counts, file = 'C:/Users/lenovo/OneDrive/Documents/avg_ride_length.csv')
